...
def build(image_set, args):
    ...
    for dataset_name in dataset_names:
        if dataset_name == 'custom_train':
            ...
            img_folder = root / "synthtext"
            ann_file = root / "synthtext" / "train.json"

        elif dataset_name == 'synthtext_val':
            img_folder = root / "synthtext"
            ann_file = root / "synthtext" / "val.json"
        
        elif dataset_name == 'ICDAR2019_train':
            img_folder = root / "ICDAR2019" / "TrainImages"
            ann_file = root / "ICDAR2019" / "train.json"
        elif dataset_name == 'ICDAR2019_test':
            img_folder = root / "ICDAR2019" / "TestImages"
    ...
    print("img_folder exists:", img_folder.exists())
    print("ann_file exists:", ann_file.exists())
