...
def get_args_parser():
    ...
    parser.add_argument('--max_size_train', type=int, default=640) #1600 
    parser.add_argument('--min_size_train', type=int, nargs='+', default=[512, 544, 576, 608, 640]) #[640, 672, 704, 736, 768, 800, 832, 864, 896]
